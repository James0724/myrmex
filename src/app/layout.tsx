...
export const metadata: Metadata = {
  ...
  description:
    "Myrmex Property Maintenance — professional power systems, security (CCTV, electric fencing, access control), networking, and system design services in Nairobi, Kenya. Certified technicians. Genuine products. Lasting results.",
  keywords: [
    ...
    "AutoCAD electrical drawings Kenya",
...
const jsonLd = {
  ...
  description:
    "Professional property maintenance services including power systems, security, networking, and system design in Nairobi, Kenya.",
  url: "https://myrmex.co.ke",
